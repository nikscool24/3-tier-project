...
This project includes a baseline set of **server security practices** to keep deployments safe, reliable, and production‑ready.
...
- Never bake secrets into images — inject them via GitHub Secrets at runtime.  
...
- Backup Postgres volumes regularly and store them off‑server (e.g., S3).  
